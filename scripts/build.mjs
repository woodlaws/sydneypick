...
const render = (html) => html.replaceAll("__SITE_URL__", config.siteUrl).replaceAll("__LAST_UPDATED__", config.lastUpdated).replaceAll('href="/#prepare"', 'href="/travel-prep"').replaceAll('href="/#food"', 'href="/food"').replaceAll('href="/#shopping"', 'href="/shopping"').replaceAll('href="/#magazine"', 'href="/magazine"').replaceAll('<p>기념품과 호주 선물 준비</p>', '<p><a href="/shopping">쇼핑픽에서 선물 기준 확인</a></p>').replaceAll('<p>일정과 위치에 따라 SDF 방문 검토</p>', '<p><a href="/shopping/sdf">일정과 위치에 따라 SDF 방문 검토</a></p>');
