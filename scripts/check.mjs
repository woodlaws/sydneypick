...
const assertions = [
  ...
  [magazineCategoriesHtml.every((page)=>page.includes('class="categoryHeroInner"')&&page.includes('class="magazineCategoryContent"')&&page.includes('class="mag-category-nav-inner categoryNavigationInner"')), "shared centered magazine category layout"],
  [magazineCategoriesHtml.every((page)=>page.includes('class="magazine-page magazineCategoryPage"'))&&magazineCss.includes('.magazineCategoryGrid[data-count="2"]')&&magazineCss.includes('max-width:900px'), "category grids respond to post count"],
