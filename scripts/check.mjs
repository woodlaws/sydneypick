...
const assertions = [
  ...
  [magazineHub.includes('class="magazineHeroInner magazineContainer"') && magazineHub.includes('class="magazineTitle"') && magazineHub.includes('class="magazineDescription"') && magazineHub.includes('class="magazineCategoryScroll"') && magazineHub.includes('magazineCategoryNavInner magazineContainer'), "shared magazine hub container and category navigation structure"],
  [magazineCategoriesHtml.every((page)=>page.includes('class="categoryHeroInner magazineContainer"')&&page.includes('class="magazineCategoryContent magazineContainer"')&&page.includes('class="magazineCategoryScroll"')&&page.includes('magazineCategoryNavInner magazineContainer')), "shared centered magazine category layout"],
  [magazineCategoriesHtml.every((page)=>page.includes('class="magazine-page magazineCategoryPage"'))&&magazineCss.includes('.magazineCategoryGrid[data-count="1"]{grid-template-columns:minmax(0,380px)')&&magazineCss.includes('.magazineCategoryGrid[data-count="2"]{max-width:790px'), "category grids respond to post count"],
